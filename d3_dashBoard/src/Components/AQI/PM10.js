    ...
    if (!PM10){
        return(<div>
             <Col style={{fontSize: 22}}>
                ...
                <text x='20' y='20'>PM10</text>
                </svg>
                </Col>
                <Col>
                <svg id='PM10' height='150' width='100' style={{marginLeft: 0, marginTop: 5}}>
                    ...
                    <text x='20' y='50' style={{fontSize:18}}>200</text>
                    </g>
                </svg>
                </Col>
        </div>)
    ...
    return(
            <div>
                ...
                <svg id='PM10' height='150' width='100' style={{marginLeft: 0, marginTop: 5}}>
                    <g transform='translate(50,60)'>
                    <path d={arc()} fill='#E4E8EA'></path>
                    <path fill={SetColor(PM10)} d={path({
                        endAngle: endpoint(PM10)
                    })}/>
                    <line x1={+x1} y1={+y1} x2={+x2} y2={+y2} style={{stroke: 'black', strokeWidth:'3px'}}></line>
                    <text x={+x1} y={+y1-12}>{MaxAllow}*</text>
                    <text x='-20' y='20'>μg/m³</text>
                    <text x='-25' y='5' style={{fontSize:32}}>{d3.format('.0f')(PM10)}</text>
                    <text x='-35' y='50' style={{fontSize:18}}>0</text>
                    <text x='20' y='50' style={{fontSize:18}}>200</text>
                    </g>
                </svg>
